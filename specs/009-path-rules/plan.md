...
| VIII. Mandatory Documentation (NN) | Every non-trivial function in the loader will carry a *why* comment tied to FR-001/-002/-003 or the anti-pattern it defends against. Per-kata README delivered during `/iikit-07-implement` covering objective, walkthrough, anti-pattern defense, run instructions, reflection. |
