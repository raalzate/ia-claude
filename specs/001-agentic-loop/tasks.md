...
- [x] T050 [P] Enrich `katas/kata_001_agentic_loop/notebook.ipynb` with Claude architecture certification content — additive, keeps existing cells. New ordered sections:
